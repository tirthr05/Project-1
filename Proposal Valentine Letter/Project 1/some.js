    ...
    function typeWriter() {
      if (i < txt1.length) {        
         if(txt1.charAt(i)=='<')
          ...
          {
            $(".bg_heart").css("background-image","url('https://img.freepik.com/premium-photo/couple-holding-hands-beach-sunset_896360-5274.jpg')");
